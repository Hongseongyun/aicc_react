            ...
            <div className="border border-neutral-700 rounded-xl p-10 text-left">
              ...
              <ul>
                {option.features.map((feature, idx) => (
                  <li className="mt-8 flex items-center gap-2" key={idx}>
                    <CheckCircle2 />
                    <span>{feature}</span>
                  </li>
                ))}
              ...
              <Link
                to={option.to}
                className="text-xl mt-20 border border-indigo-600 rounded-lg w-full flex justify-center py-2 tracking-tight hover:bg-indigo-600 transition-all duration-300"
              >
                Subscribe
              </Link>
            </div>
